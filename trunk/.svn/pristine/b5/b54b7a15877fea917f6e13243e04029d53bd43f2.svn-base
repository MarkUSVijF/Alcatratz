...
public class Game implements Serializable {
    ...
    public boolean isFull() {
        return this.gameInfo.isFull(); //simple
    }

    public Player removePlayer(String playerConnection) throws GameException {
        ...
        if (playerID != null) {
           return this.gameInfo.removePlayer(playerID);
        }
        return null;
    }

    public Player forceRemovePlayer(String playerConnection) throws GameException {
    ...
    public boolean isEmpty() {
        return this.gameInfo.getPlayersInGame() == 0; //simple
    }
    ...
    public int getVersion() {
        return this.gameInfo.getVersion(); //simple
    }

    public Integer getPlayerID(String connection){
        return this.playerConnections.get(connection);
    }
}
