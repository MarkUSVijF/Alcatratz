...
public class LocalNetwork {
    ...
    public static Set<String> getIPv4() {
        ...
        try {
            ...
            logger.log(Level.SEVERE, "{0} -> there was a socket exception", Thread.currentThread().getName());
        }
        if (networks == null) {
            return result;
        }
        while (networks.hasMoreElements()) {
            ...
            for (InterfaceAddress address : addresses) {
                ...
                logger.log(Level.INFO, "{0} -> IPv4: {1}", new Object[]{Thread.currentThread().getName(), address.toString()});
        ...
        try {
            ...
            return result;
                ...
                logger.log(Level.SEVERE, "{0} -> IOException", Thread.currentThread().getName());
        } finally {
            try {
                if (ipconfig != null) {
                    ipconfig.close();
