...
import javax.swing.*;
import net.technikumwien.bic4b18_01.client.appllicationMW.Middleware;
import net.technikumwien.bic4b18_01.common.rmi.GameInfo;
import java.util.Set;
import java.util.logging.Level;
import java.util.logging.Logger;
import net.technikumwien.bic4b18_01.client.appllicationMW.ToServer;
...
public class GUI extends javax.swing.JFrame {
    ...
    private final DefaultListModel<String> listModelGame;
    private final DefaultListModel<String> listModelPlyName;
    ...
    public GUI() {
        ...
        this.listModelGame = new DefaultListModel<>();
        this.listModelPlyName = new DefaultListModel<>();
        ...
        logger.log(Level.INFO, "{0} -> daemon ? {1}.", new Object[]{Thread.currentThread().getName(), Thread.currentThread().isDaemon()});
        refresher.setDaemon(true);
        refresher.setName("GUI refresher");
        refresher.start();
    ...
    public void refreshGame(GameInfo game) {
        ...
        logger.log(Level.INFO, "{0} -> refreshed Game:{1}.", new Object[]{Thread.currentThread().getName(), game.getGameID()});
    }
